...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products.
  ...
  <Model key="Model_1" name="Model to test bug in sbmodelr" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221407599999999e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2025-09-11T23:36:41Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
    <dcterms:creator>
      <rdf:Description>
    ...
    <Comment>
      This model contains two species with the same name but different compartments. This is allowed, their internal names are ATP{cytoplasm} and ATP{mitochondria}.

The inclusion of braces in the names seems to cause a bug in sbmodelr
    </Comment>
    <ListOfCompartments>
...
<rdf:Description rdf:about="#ModelValue_0">
        ...
        <Expression>
          &lt;CN=Root,Model=Model to test bug in sbmodelr,Vector=Compartments[cytoplasm],Vector=Metabolites[ATP],Reference=InitialConcentration>/&lt;CN=Root,Model=Model to test bug in sbmodelr,Vector=Compartments[mitochondria],Vector=Metabolites[ATP],Reference=InitialConcentration>
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
      <Reaction key="Reaction_0" name="transport" reversible="true" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_1" name="k2" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="r1" reversible="false" fast="false" addNoise="false">
        ...
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Model to test bug in sbmodelr,Vector=Compartments[cytoplasm]">
          <ListOfCallParameters>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Model to test bug in sbmodelr" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Model to test bug in sbmodelr,Vector=Compartments[cytoplasm]" value="1" type="Compartment" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Model to test bug in sbmodelr,Vector=Reactions[transport]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Model to test bug in sbmodelr,Vector=Reactions[transport],ParameterGroup=Parameters,Parameter=k1" value="0.10000000000000001" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Model to test bug in sbmodelr,Vector=Reactions[transport],ParameterGroup=Parameters,Parameter=k2" value="0.10000000000000001" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Model to test bug in sbmodelr,Vector=Reactions[r1]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Model to test bug in sbmodelr,Vector=Reactions[r1],ParameterGroup=Parameters,Parameter=k1" value="0.10000000000000001" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
        </ModelParameterGroup>
      </ModelParameterSet>
